 ...
 * @since 1.0.0
 */
function gutestrap_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'gutestrap-cgb-style-css', // Handle.
	...
	wp_register_style(
		'gutestrap-cgb-block-editor-css', // Handle.
